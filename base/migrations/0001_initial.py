# Generated by Django 4.1 on 2023-04-09 11:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.CharField(blank=True, max_length=191, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Department',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, default='', max_length=191, null=True)),
                ('about', ckeditor.fields.RichTextField(blank=True, null=True)),
                ('event_start_date', models.DateField(blank=True, null=True)),
                ('event_end_date', models.DateField(blank=True, null=True)),
                ('department', models.CharField(blank=True, default='', max_length=191, null=True)),
                ...
                ('event_end_time', models.TimeField(blank=True, max_length=191, null=True)),
                ...
                ('event_price', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('num_likes', models.IntegerField(blank=True, default=1, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document', models.FileField(blank=True, null=True, upload_to='brochures/')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.events')),
            ],
